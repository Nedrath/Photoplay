  ...
  return (
    <nav className={styleNav}>
      <Link to="/" className={styleLink}>
        <Navigation icon={iconHome} text="home" />
      </Link>
      <Link to="/search" className={styleLink}>
        <Navigation icon={iconSearch} text="search" />
      </Link>
      <Link to="/downloads" className={styleLink}>
        <Navigation icon={iconDownloads} text="downloads" />
      </Link>
      <Link to="" className={styleLink}>
        <Navigation icon={iconProfile} text="profile" />
      </Link>
    </nav>
  );
};
